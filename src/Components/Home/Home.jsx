                ...
                <div className='ToDo'>
                    <div className='ToDo_Header'>
                        <div className='ToDo_Header_Left'>
                            ...
                            <div className='ToDo_Header_Left_Posts'>3</div>
                        </div>
                    ...
                    <div className='ToDo_Content'>
                        {
                            tasks
                                .filter(task => task.statusId === 1) // lọc các task có trạng thái To Do
                                .map(task => (
                                    <Task
                                        key={task.taskId}
                                        title={task.title}
                ...
                <div className='InProgress'>
                    <div className='InProgress_Header'>
                        <div className='InProgress_Header_Left'>
                            ...
                            <div className='InProgress_Header_Left_Posts'>2</div>
                        </div>
                    ...
                    <div className='InProgress_Content'>
                        {
                            tasks
                                .filter(task => task.statusId === 2) // lọc các task có trạng thái To Do
                                .map(task => (
                                    <Task
                                        key={task.taskId}
                                        title={task.title}
                ...
                <div className='InReview'>
                    <div className='InReview_Header'>
                        <div className='InReview_Header_Left'>
                            ...
                            <div className='InReview_Header_Left_Posts'>2</div>
                        </div>
                    ...
                    <div className='InReview_Content'>
                        {
                            tasks
                                .filter(task => task.statusId === 3) // lọc các task có trạng thái To Do
                                .map(task => (
                                    <Task
                                        key={task.taskId}
                                        title={task.title}
                ...
                <div className='Done'>
                    <div className='Done_Header'>
                        <div className='Done_Header_Left'>
                            ...
                            <div className='Done_Header_Left_Posts'>2</div>
                        </div>
                    ...
                    <div className='Done_Content'>
                        {
                            tasks
                                .filter(task => task.statusId === 4) // lọc các task có trạng thái To Do
                                .map(task => (
                                    <Task
                                        key={task.taskId}
                                        title={task.title}
